...
$lang = array_merge($lang, array(
	...
	'ACP_REWRITE_CONF_EXPLAIN'	=> 'To narzędzie pomoże Ci zbudować Twój .htacess.<br/>Wersja zaproponowana poniżej opiera się na Twoich ustawieniach phpbb_seo/phpbb_seo_class.php.<br/>Możesz zmienić wartości $seo_ext i $seo_static zanim zainstalujesz .htaccess aby otrzymać zpersonalizowane adresy URLs.<br/>Dla przykładu możesz wybrać .htm zamiast .html, \'wiadomosc\' zamiast \'post\' \'ekipa\' zamiast \'the-team\' itd.<br/>Jeśli zmienisz te wartości w chwili kiedy już zostały zindeksowane, musisz zmienić przekierowania.<br/>Domyślne ustawienia nie są złe mimo wszystko, możesz pominąć ten krok jeżeli tak uważasz.<br/>Teraz jest najlepszy czas aby to zrobić, później będzie wymagało utworzenia dodatkowych przekierowań.<br/>Domyślnie .htaccess powinien znaleźć sie w katalogu głównym domeny (np gdzie www.przyklad.pl jest odsyłany).<br/>Jeśli phpBB jest zainstalowane w podkatalogu, wybranie więcej opcji poniżej doda opcję zapisu w folderze w którym jest zainstalowane phpBB.',
	'SEO_SERVER_CONF_RBASE'	=> 'lokalizacja .htaccess',
	'SEO_SERVER_CONF_RBASE_EXPLAIN' => 'Umieścić .htaccess w folderze phpBB ?<br/>Ustawienia RewriteBase pozwolą na umieszczenie .htaccess w folderze gdzie zainstalowany jest phpBB. Jest to zwłaszcza bardzo wygodne aby zapisać .htaccess w folderze domeny nawet jeśli phpBB jest zainstalowane w podfolderze, ale może umieścić plik w folderze phpBB.',
	'SEO_SERVER_CONF_SLASH'	=> 'RegEx Prawy Ukośnik',
	'SEO_SERVER_CONF_SLASH_EXPLAIN'	=> 'W zależności od hostingu jaki używasz, możesz pozbyć się lub dodać ukośnik ("/") na początku prawej części każdego rewriterules. Ten ukośnik jest używany domyślnie kiedy .htaccess jest umieszczony w folderze domeny. Jest to przeciwieństwo kiedy phpBB jest zainstalowane w podfolderze a Ty chcesz używać .htaccess w tym samym folderze.<br/>Ustawienia domyślne powinny generalnie działać, ale jeśli nie działają, spróbuj wygenerować .htaccess poprzez nacisnięcie przycisku "Re-generate".',
	'SEO_SERVER_CONF_WSLASH'	=> 'RegEx Lewy Ukośnik',
	'SEO_SERVER_CONF_WSLASH_EXPLAIN'	=> 'W zależności od hostingu jaki używasz, możesz dodać ukośnik ("\") na początku lewej części każdego rewriterules. Ten ukośnik ("\") domyślnie nie jest nigdy używany.<br/>Ustawienia domyślne powinny generalnie działać, ale jeśli nie działają, spróbuj wygenerować .htaccess poprzez nacisnięcie przycisku "Re-generate".',
	...
	'SEO_SERVER_CONF_SAVE' => 'Zapisz .htaccess',
	'SEO_SERVER_CONF_SAVE_EXPLAIN' => 'Jeśli zaznaczone, plik .htaccess będzie wygenerowany podczas wysyłania w folderze phpbb_seo/cache/. Jest gotowy do użycia z Twoimi ustawieniami, ale musisz go przenieść we właściwe miejsce.',
	...
	'SEO_SERVER_CONF_CAPTION' => 'Legenda',
	'SEO_SERVER_CONF_CAPTION_COMMENT' => 'Komentarze',
	'SEO_SERVER_CONF_CAPTION_STATIC' => 'Statyczne części, edytowane w phpBB/ext/phpbbseo/usu/customise.php',
	'SEO_SERVER_CONF_CAPTION_DELIM' => 'Separatory, edytowane w phpBB/ext/phpbbseo/usu/customise.php',
	'SEO_SERVER_CONF_CAPTION_SUFFIX' => 'Przyrostki, edytowane w phpBB/ext/phpbbseo/usu/customise.php',
	'SEO_SERVER_CONF_CAPTION_SLASH' => 'Opcjonalne ukośniki',
	'SEO_SLASH_DEFAULT'	=> 'Domyślnie',
	'SEO_SLASH_ALT'		=> 'Zastąpiono',
	'SEO_MOD_TYPE_ER'	=> 'Typ nadpisywania nie jest ustawiony poprawnie w phpBB/ext/phpbbseo/usu/core.php.',
	'SEO_SHOW'		=> 'Pokaż',
	'SEO_HIDE'		=> 'Ukryj',
	'SEO_SELECT_ALL'	=> 'Zaznacz wszystko',
	'SEO_APACHE_CONF' => 'Ustawienia Apache',
	//Ngix
	'SEO_NGIX_CONF' => 'Ustawienia NginX',
	'SEO_NGIX_CONF_EXPLAIN' => 'Skopiuj ten plik i wklej do konfiguracji NginXa po czym zrestartuj Ngix.',
	// ACP extended
	...
	'SEO_EXTERNAL_SUBDOMAIN_EXPLAIN' => 'Otwieraj lub nie, linki do sub-domen Twojej domeny jako wewnętrzne linki w tym samym oknie',
	...
	'SEO_META_FB_APP_ID' => 'ID aplikacji Facebooka',
